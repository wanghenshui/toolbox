...
if __name__=='__main__':
     print('+-----------------------------------------+')
     print("|           TSC  Upload One               |")
     print("|                                         |")
     print('|                    -all wrongs reserved |')
     print('+-----------------------------------------+')
     print(u'程序功能:')
     print(u'新建一个目录，将你想上传的模块和本程序放在目录下,')
     print(u'运行程序会将同目录下所有文件上传，且将服务器中已有的文件备份')
     print(u'崩溃发日志到w18858 rtx/notes 或者skype wangqw2ee@outlook.com')

     hostname=input(u"tsc ip (没有ip校验，别输错了):\n")

     key=input(u"tsc 密码 默认vos:\n")
     if key != '':
         password=key
     threads = []
     for i in hostname:
