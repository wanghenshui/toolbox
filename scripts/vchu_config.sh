...
echo "--------------------------------------------------------"
echo "|TSCSC ip config script ,and use for version   6.0 6.1 |"
echo "|                                                      |"
...
update Tbl_Config set value = replace (value,'20.0.2.43','$TSC_IP');
...
update Tbl_Config set Value='$TSC_IP:0' where  Tag='TSC'and Key='TSC_IntraNetIP';
/* Agent ÅäÖÃÐÞ¸Ä*/
...
update Tbl_Config set Value='$VCHUC_ID'        where  Tag='Agent'and Key='VCHUC_ID';
